...
function AdminMain() {
  ...
  const getRequestCount = async () => {
    await axios
      .get("http://localhost:3333/bca-app/requestsCount")
      .then((response) => {
        ...
        <div className="row">
          <div className="col-md">
            <div className="container">
              ...
              >
                ...
                >
                  Data Update : {date.toDateString()}{" "}
                  {date.toLocaleTimeString()}
                </h2>
                <div
                  className="row mx-auto centered-row"
                  style={{ marginTop: "6vh", marginBottom: "5vh" }}
                >
                  <div className="row">
                    <div className="col-sm">
                      ...
                      >
                        {" "}
                        Primacom : {providerCount.primacom}/2550{" "}
                      </p>
                    </div>
                  ...
                  <div className="row">
                    <div className="col-sm">
                      ...
                      >
                        {" "}
                        Tangara : {providerCount.tangara}/2550{" "}
                      </p>
                    </div>
                    <div className="col-lg">
                      <CustomProgressBar
                  ...
                  <div className="row">
                    <div className="col-sm">
                      ...
                      >
                        {" "}
                        Iforte : {providerCount.iforte}/2550{" "}
                      </p>
                    </div>
                    <div className="col-lg">
                      <CustomProgressBar
                  ...
                  <div className="row">
                    <div className="col-sm">
                      ...
                      >
                        {" "}
                        Indonet : {providerCount.indonet}/2550{" "}
                      </p>
                    </div>
                    <div className="col-lg">
                      <CustomProgressBar
          ...
          <div className="col-md text-center mx-3">
            <div className="row">
              ...
              <div
                className="container-fluid text-center mr-3 mt-3 mb-3"
                style={{
              ...
              >
                ...
                >
                  <div className="col-sm align-items-center justify-content-center">
                    <div
                      style={{
                        backgroundColor: isHoveredThird
                          ? "white"
                          : "transparent",
                        borderRadius: "5px",

                        boxShadow: isHoveredThird
                  ...
                  <div className="col-sm align-items-center justify-content-center">
                    <div
                      style={{
                        backgroundColor: isHoveredFourth
                          ? "white"
                          : "transparent",
                        borderRadius: "5px",

                        boxShadow: isHoveredFourth
                          ? "10px 10px 20px rgba(33, 156, 144, 0.3)"
                          : "none",
                        transition: "background-color 0.2s, box-shadow 0.2s",
                        height: "35vh",
                      ...
                      onClick={() =>
                        (window.location.href = "/admin/dismantleHistory")
                      }
                      className="d-flex align-items-center justify-content-center"
                    >
                      <div className="row">
                        ...
                        <div style={{ height: "5vh" }}>
                          <h3
                            style={{
                              marginTop: "5vh",
                              visibility: isHoveredFourth
                                ? "visible"
                                : "hidden", // Show text on hover
                  ...
                  <div className="col-sm align-items-center justify-content-center">
                    <div
                      style={{
                        backgroundColor: isHoveredFifth
                          ? "white"
                          : "transparent",
                        borderRadius: "5px",

                        boxShadow: isHoveredFifth
                          ? "10px 10px 20px rgba(33, 156, 144, 0.3)"
                          : "none",
                        transition: "background-color 0.2s, box-shadow 0.2s",
                        height: "35vh",
